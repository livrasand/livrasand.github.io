...
<div class="label-container svelte-35xm21" style="display: flex; justify-content: space-between; align-items: left;">
  ...
  <a class="button style-hyperlink svelte-nqc07q" style="background:#231f20;color:#fff;font-size:10px;border-radius:180px;padding:0 10px 0 10px;" href="${publication.downloadURL}" download="" target="_blank" rel="noreferrer noopener" role="button">
    ...
    <div class="_4ed4187c flex flex-row-reverse relative"><div class="d76ccfa5 _625ca439" style="background-color: #cb3837;margin-top:2px;"></div><div class="_89d0b3e5">M</div>&nbsp;&nbsp;&nbsp;&nbsp;
    <div class="d76ccfa5 _625ca439" style="background-color: #8956ff;margin-top:2px;"></div><div class="_89d0b3e5">C</div>&nbsp;&nbsp;&nbsp;&nbsp;
    <div class="d76ccfa5 _625ca439" style="background-color: #29abe2;margin-top:2px;"></div><div class="_89d0b3e5">P</div></div>
  </div> 
      `;
